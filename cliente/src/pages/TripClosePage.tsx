    ...
    <Page>
      {loading ? <div>Cargando información</div> :
        <Paper>
          ...
          <Title>tu viaje ha terminado</Title>
          <WhiteSpace />
          <Steps current={1}>
            <Steps.Step title="punto de embarque" icon={customIcon()} description={tripInfo && tripInfo.origin.address} />
            <Steps.Step title="punto de destino" icon={customIcon()} description={tripInfo && tripInfo.destination.address} />
          </Steps>
          <WhiteSpace />
