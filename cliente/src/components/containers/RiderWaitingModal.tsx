...
function RiderWaitingForm() {
  ...
  const retryNotify = () => {
    if (callToggle === 0) {
      ...
      alert('Solicitud fallida', 'No hay conductor disponible.', [
  ...
  return (
    <>
      ...
      <PickUpCancelButton content={'cancelar'} onClick={handleClickCancel}/>
      <Message >{!!callToggle ? 'Amplíe su alcance y explore de nuevo...' : 'Buscando conductores cercanos...'}</Message>
    </>
  );
}
