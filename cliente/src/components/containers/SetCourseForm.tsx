...
import PerfilButton from '../presentational/PerfilButton';
...
const PerfilPosition = styled.div`
position: absolute;
right: 8px;
top: 12px;
z-index: 100;
...
function SetCourseForm() {
  ...
  const makeStartingPointHere = async() => {
    ...
    dispatch(setOriginMarker('Ubicación actual'));
  };
  ...
  return (
    <>
      ...
      />
      <WhiteSpace />
      <HereButton onClick={makeStartingPointHere}>ubicación actual</HereButton>
      <WhiteSpace />
      <PlaceSearchBox
